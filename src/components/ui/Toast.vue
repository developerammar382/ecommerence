    ...
    <div class="fixed bottom-4 right-4 z-50 space-y-3">
      <TransitionGroup name="toast">
        <div 
          ...
          :key="toast.id"
          class="flex items-center gap-3 p-4 rounded-lg shadow-lg max-w-md animate-slide-up"
        ...
        >
          ...
          <button @click="removeToast(toast.id)" class="flex-shrink-0 text-current hover:opacity-70 transition-opacity">
